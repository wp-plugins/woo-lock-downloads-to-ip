...
Go to Woocommerce > Settings > General, add the necessary Info in fields and save it. Check the screenshot for more info
...
== Changelog ==
= 1.1 =
* Updated compatibility with latest woocommerce.
